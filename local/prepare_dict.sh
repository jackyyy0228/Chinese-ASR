...
dictdir=data/dict
lexicon=/home/jacky/work/kgb/corpus/text_lexicon.txt

train_dir=data/CyberonChinese
lm_text=/home/jacky/work/kgb/corpus/text
dict_dir=data/dict
...
cat $train_dir/text $lm_text | awk '{for (i = 2; i <= NF; i++) print $i}' |\
...
echo "$0: Cyberon dict preparation succeeded"
exit 0;
