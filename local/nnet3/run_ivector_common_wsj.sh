...
stage=0
nj=2
train_set=cyberon_train   # you might set this to e.g. train.
test_sets=cyberon_test
...
if [ $stage -le 4 ]; then
  ...
  steps/online/nnet2/train_ivector_extractor.sh --cmd "$train_cmd" --nj 8 --num-processes 1 --num-threads 1 \
